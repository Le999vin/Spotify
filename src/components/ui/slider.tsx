...
>(({ className, ...props }, ref) => (
  ...
  >
    ...
    <SliderPrimitive.Thumb className="block h-3.5 w-3.5 rounded-full border border-white/20 bg-white shadow-sm transition-colors focus-visible:ring-2 focus-visible:ring-[var(--ring)]" />
  </SliderPrimitive.Root>
));
